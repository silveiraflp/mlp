<?php
    ...
    define("TAMANHO_GRID"       , 45); // n�mero de pixes
    define("QTD_NAVIOS"         , 3);
...
<script>
    function atirar(linha, coluna, paradigma)
    {
        ...
        .done(function( retorno ) {
            ...
            else // Acertou embarca��o
            {
                ...
                if (retorno == 1) // Afundou embarca��o
                {
    ...
    function verificarFim(paradigma)
    {
        ...
        .done(function( qtdEmbarcacoes ) {
            ...
            if (qtdEmbarcacoes == 0)
                alert( "Voc� afundou todas �s embarca��es! Fim de Jogo!" );
        });   
    }
